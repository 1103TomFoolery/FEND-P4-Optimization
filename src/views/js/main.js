...
var resizePizzas = function(size) { 
  ...
  function changePizzaSizes(size) {
    var l = document.querySelectorAll(".randomPizzaContainer").length; // moved calculation of iteration limit out of the loop so it's only done once
    for (var i = 0; i < l; i++) {
